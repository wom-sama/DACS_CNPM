...
If this single A1 also fails, stop local XCNorm. The evidence-backed next family is a lightweight ordinal/ambiguity head on the preserved B9 teacher: the five quality states have an order, while source-mixed `0/1/2` samples need uncertainty-aware supervision rather than automatic relabelling. This is supported by work on adjacent-category sequence decisions ([Ord2Seq, ICCV 2023](https://openaccess.thecvf.com/content/ICCV2023/html/Wang_Ord2Seq_Regarding_Ordinal_Regression_as_Label_Sequence_Prediction_ICCV_2023_paper.html)), ordinal learning under class-conditional label noise ([PMLR 2020](https://proceedings.mlr.press/v129/garg20a.html)), and a directly relevant ordinal meta-learning study for five-stage fruit quality ([CVPR Workshops 2025](https://openaccess.thecvf.com/content/CVPR2025W/MTF/html/Jain_Privacy_Preserving_Ordinal-Meta_Learning_with_VLMs_for_Fine-Grained_Fruit_Quality_CVPRW_2025_paper.html)). It remains deferred and receives no run until A1 is terminal.
