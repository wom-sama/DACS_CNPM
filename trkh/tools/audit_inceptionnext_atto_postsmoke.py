...
def run_audit(
    *,
    ...
    if pair.get("method") != "inceptionnext_atto_surface_tokenizer":
    ...
    summary: Dict[str, object] = {
        "mode": "inceptionnext_atto_postsmoke_closure",
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Close an InceptionNeXt-Atto smoke with robustness, trace, and XAI evidence."
    )
