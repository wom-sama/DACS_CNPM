param(
    ...
    [string]$RunName = "mango_cls_256_5class_mixstyle_v23_30e",
    ...
    [double]$MixStyleProbability = 0.50,
    [double]$MixStyleAlpha = 0.10,
    [switch]$Probe,
...
if ($Probe) {
    if (-not $PSBoundParameters.ContainsKey("RunName")) {
        $RunName = "probe_mango_cls_256_5class_mixstyle_v23_120b_6e"
    }
