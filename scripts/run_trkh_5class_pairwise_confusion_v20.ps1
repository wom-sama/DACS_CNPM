param(
    ...
    [string]$RunName = "mango_cls_256_5class_pairwise_confusion_v20_30e",
    ...
    [double]$PairwiseConfusionLossWeight = 0.04,
    [string]$PairwiseConfusionSources = "head,patch",
...
if ($Probe) {
    if (-not $PSBoundParameters.ContainsKey("RunName")) {
        $RunName = "probe_mango_cls_256_5class_pairwise_confusion_v20_120b_6e"
    }
