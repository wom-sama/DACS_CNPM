param(
    ...
    [string]$RunName = "mango_cls_256_5class_fg_bg_mix_v22_30e",
    ...
    [double]$ForegroundBackgroundMixProbability = 0.35,
...
if ($Probe) {
    if (-not $PSBoundParameters.ContainsKey("RunName")) {
        $RunName = "probe_mango_cls_256_5class_fg_bg_mix_v22_120b_6e"
    }
