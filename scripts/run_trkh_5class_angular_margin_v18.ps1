param(
    ...
    [string]$RunName = "mango_cls_256_5class_angular_margin_v18_30e",
    ...
    [double]$AngularMarginLossWeight = 0.05,
    [double]$AngularMargin = 0.10,
    [double]$AngularMarginScale = 16.0,
    [int]$AngularMarginStartEpoch = 1,
...
if ($Probe) {
    if (-not $PSBoundParameters.ContainsKey("RunName")) {
        $RunName = "probe_mango_cls_256_5class_angular_margin_v18_120b_6e"
    }
