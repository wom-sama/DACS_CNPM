param(
    ...
    [string]$RunName = "mango_cls_256_5class_foreground_surface_v13_30e",
...
if ($Probe) {
    if (-not $PSBoundParameters.ContainsKey("RunName")) {
        $RunName = "probe_mango_cls_256_5class_foreground_surface_v13_120b_6e"
    }
