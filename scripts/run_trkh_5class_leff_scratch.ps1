param(
    ...
    [string]$RunName = "smoke_v8_yolof_leff1234_scratch_20b_1e_20260711",
    [int]$Epochs = 1,
...
if ($LocallyEnhancedFfnKernelSize -lt 3 -or ($LocallyEnhancedFfnKernelSize % 2) -eq 0) {
    throw "LocallyEnhancedFfnKernelSize must be odd and at least 3."
}
...
$Args = @{
    ...
    LocallyEnhancedFfn = $true
    LocallyEnhancedFfnLayers = $LocallyEnhancedFfnLayers
    LocallyEnhancedFfnKernelSize = $LocallyEnhancedFfnKernelSize
    SkipFinalTest = $true
